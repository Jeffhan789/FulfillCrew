...
> **目标读者**：正在学习本项目、准备技术架构复盘的开发者。本文档假设你已具备 Python、JavaScript 基础，希望深入理解每个技术选型的"为什么"。

---

## 1. 项目定位：一个"教学级"工程参考实现

FulfillCrew（智仓通）不是 toy project，也不是 enterprise SaaS。它刻意设计在**"学生能读懂、评审者能追问"**的甜蜜点上：
...
| 决策点 | 选型 | 为什么选它 | 架构复盘中如何表达 |
|--------|------|-----------|-------------|
| 前端框架 | React 18 + TypeScript | 生态最大，TypeScript 提供类型安全，架构复盘中几乎必问 | "React 18 的并发特性（Concurrent Features）让我们在不阻塞 UI 的情况下处理大量订单状态更新" |
...
| [08 架构复盘问答](08_design_review_qa.md) | 高频架构复盘题 + 参考答案 + 追问方向 | 全栈技术架构复盘 |
